...
- `docs/final_method_summary.md`: concise method summary for the report.
...
The tests check submission formatting, complete prediction arrays, no PassengerId-level hardcoding, and rejection of risky probe or single-flip source patterns.

## Compliance Note

The final method uses complete model outputs, complete notebook outputs, model-level probability blending, global thresholds, and complete-source agreement rules. It does not use PassengerId-level hardcoding, public-label overwrite, bitstrings, single-row flips, or leaderboard probe logic.
